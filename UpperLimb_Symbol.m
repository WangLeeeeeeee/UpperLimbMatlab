...
% 绳索节点坐标
% 基座上六个绳索节点（相对于0坐标系）
B10 = [-0.142,-0.110,0.033]*1000;
B20 = [-0.142,0,0.033]*1000;
B30 = [-0.037,0.137,0.020]*1000;
B40 = [0.037,0.137,0.020]*1000;
B50 = [0.142,0,0.033]*1000;
B60 = [0.142,-0.110,0.033]*1000;
% 上臂四个绳索节点（相对于3坐标系）
...
len4 = sqrt((B60(1)-U40(1))^2 + (B60(2)-U40(2))^2 + (B60(3)-U40(3))^2);
len5 = sqrt((B20(1)-U50(1))^2 + (B20(2)-U50(2))^2 + (B20(3)-U50(3))^2) + sqrt((U50(1)-F10(1))^2 + (U50(2)-F10(2))^2 + (U50(3)-F10(3))^2);
len6 = sqrt((B50(1)-U60(1))^2 + (B50(2)-U60(2))^2 + (B50(3)-U60(3))^2) + sqrt((U60(1)-F20(1))^2 + (U60(2)-F20(2))^2 + (U60(3)-F20(3))^2);
%len5 = sqrt((B20(1)-F10(1))^2 + (B20(2)-F10(2))^2 + (B20(3)-F10(3))^2);
%len6 = sqrt((B50(1)-F20(1))^2 + (B50(2)-F20(2))^2 + (B50(3)-F20(3))^2);
