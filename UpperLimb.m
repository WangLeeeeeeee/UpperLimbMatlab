...
%% 绳索节点坐标
% 基座上六个绳索节点（相对于0坐标系）
B10 = [-0.142,-0.027,0.033]*1000;
B20 = [-0.142,0.027,0.033]*1000;
B30 = [0,0.142,0.033]*1000;
B40 = [0,0.142,0.033]*1000;
B50 = [0.142,-0.027,0.033]*1000;
B60 = [0.142,-0.045,0.033]*1000;
% 上臂四个绳索节点（相对于3坐标系）
U13 = [0.1715,-0.035,0.125]*1000;
U23 = [0.1715,0,0.125]*1000;
U33 = [0.1715,0,-0.125]*1000;
U43 = [0.1715,-0.035,-0.125]*1000;
